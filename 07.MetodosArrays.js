...
console.log('Metodo CONCAT ' + frutas.concat('limón'))

//EVERY : nos obliga a que todos los elementos del array cumplan una determinada condición 
// si todas las frutas son igual a Sandia (por eso el falso)
...
//en la consola muestra verdadero el 1 y el 6 y Falso 2 a 5 (dice la posicion) 
...
//FOREACH:Por cada elemento nos recorre array  (length longitud)
...
//INDEXOF:Nos devuelve un numero negativo si no encuentra el elemento en el array y si lo encuentra nos dice la posición que ocupa 

console.log('indexOf (existe) ' + frutas.indexOf('uva'))
console.log('indexOf (no existe) ' + frutas.indexOf('banana'))
...
//LASTINDEXOF: nos busca la ultima que tengamos (en caso de tener los valores iguales)

console.log(frutas.lastIndexOf('sandia'))

//LENGTH(propiedad) mide la longitud del array (elementos) y si lo uso en un string cuenta la cantidad de letras
...
//en el body del documento inserta HTML
empresa.map(em=>{
